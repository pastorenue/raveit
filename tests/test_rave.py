...
pin = 3310
otp = 12345
card = Card('5399838383838381', '470', '10', '22') # Card instance
...
class TransactionTest(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.get(pk=1)
        self.payloader = BasePayloader(2300, self.user, card, 'FLWPUBK-18b01b5b8141e1f22eb166759ae7c064-X', '202.89.233.104')
    ...
    def test_encryted_payload(self):
        ...
        self.assertNotIsInstance(encrypted_data, str)
